...
EXTRA_BUILD_CONFIGURATION_FLAGS="$EXTRA_BUILD_CONFIGURATION_FLAGS --disable-muxers --enable-muxer=mp3,adts,ipod,flac,ogg,wav,aiff,matroska,mp4,tta,null,amr,gsm"
